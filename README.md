...
This repository contains both the **Frontend Mobile App** (React Native with Expo) and the **Backend API** (Django, Django REST Framework, Channels, PostgreSQL) for the Smart Tissue Dispenser project.
