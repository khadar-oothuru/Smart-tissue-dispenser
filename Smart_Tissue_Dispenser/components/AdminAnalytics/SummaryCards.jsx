...
const SummaryCards = ({
  ...
  const {
    ...
    batteryOffCount, // Only battery_percentage = 0
  ...
  if (selectedAlertType === "tissue") {
    ...
    // Show Battery Off as the first card
    cards = [
      {
        title: "Battery Off",
        ...
        fullWidth: false,
        onPress: () => navigation.navigate("BatteryOffScreen"),
      },
      {
        title: "Need charge",
        ...
        color: "#D84315",
        lightBg: "#FFCCBC",
        darkBg: isDark ? "#3E2723" : "rgba(216, 67, 21, 0.18)",
  ...
  if (selectedAlertType === "tissue") {
    ...
    // Render battery cards in 2 rows of 2, properly aligned
    return (
      <View style={styles.container}>
        <View style={styles.rowWrap}>
          <AnimatedCard
