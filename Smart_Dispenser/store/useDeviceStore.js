...
import { handleDeviceOperationResponse } from "../utils/deviceUtils.js";
  ...
  addDevice: async (token, deviceData) => {
    ...
    try {
      ...
      set({
        error: errorMessage,
        loading: false,
        operationMessage: handleDeviceOperationResponse("add", false).message,
      });
      throw err;
    }
  },
  updateDevice: async (token, id, data) => {
    ...
    try {
      ...
      set((state) => ({
        ...
        loading: false,
        error: null,
        operationMessage: handleDeviceOperationResponse("update", true).message,
        lastDataUpdate: new Date().toISOString(),
      }));
      ...
      set({
        error: errorMessage,
        loading: false,
        operationMessage: handleDeviceOperationResponse("update", false)
          .message,
      });
      throw err;
    }
  ...
  deleteDevice: async (token, id) => {
    ...
    try {
      ...
      set((state) => ({
        ...
        loading: false,
        error: null,
        operationMessage: handleDeviceOperationResponse("delete", true).message,
        lastDataUpdate: new Date().toISOString(),
      }));
      ...
      set({
        error: errorMessage,
        loading: false,
        operationMessage: handleDeviceOperationResponse("delete", false)
          .message,
      });
      throw err;
    }
